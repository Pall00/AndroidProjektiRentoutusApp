...
public class GlobalTrivias {
     ...
     * @return ourInstance, the GlobalTrivias object created inside this class that holds all the data given to it
     */
     ...
     * @return triviaList, the list that holds the Trivia objects
     */
