...
public class User {
    ...
    /**
     * This is constructor for creating new user. As it is private, it can be and is only called inside this class.
     */
    private User(){
    }
     ...
     * @return BMI, the body mass index of the user.
     */
     ...
     * @return timer, returns the value of the timer in milliseconds.
     */
